...
ApplicationWindow {
    ...
    SwipeView {
        ...
        Page {
            ...
            Label {
                ...
                wrapMode: Label.WordWrap
                anchors.top: Qt.platform.os
                             === "android" ? androidInfoLabel.bottom : infoLabel.bottom
                anchors.left: parent.left
                anchors.topMargin: 24
                anchors.leftMargin: 24
                anchors.right: parent.right
        ...
        Page {
            ...
            Button {
                ...
                onClicked: {
                    if (sendSwitch.currentIndex === index_PNG) {
                        shareUtils.sendFile(copyFileFromAppDataIntoDocuments(
                                                request_NO_RESPONSE_IMAGE),
                                            "Send File", "image/png",
                                            request_NO_RESPONSE_IMAGE,
                                            appWindow.useAltImpl)
                        return
                    }
                    if (sendSwitch.currentIndex === index_JPEG) {
                        shareUtils.sendFile(copyFileFromAppDataIntoDocuments(
                                                request_NO_RESPONSE_JPEG),
                                            "Send File", "image/jpeg",
                                            request_NO_RESPONSE_JPEG,
                                            appWindow.useAltImpl)
                        return
                    }
                    ...
                    if (sendSwitch.currentIndex === index_PDF) {
                        shareUtils.sendFile(copyFileFromAppDataIntoDocuments(
                                                request_NO_RESPONSE_PDF),
                                            "Send File", "application/pdf",
                                            request_NO_RESPONSE_PDF,
                                            appWindow.useAltImpl)
                        return
                    }
            ...
            Button {
                ...
                text: Qt.platform.os
                      === "android" ? qsTr("Send File with Result\n(recommended)") : qsTr(
                                          "Send File with RequestId\n(recommended)")
                onClicked: {
                    if (sendSwitch.currentIndex === index_PNG) {
                        shareUtils.sendFile(copyFileFromAppDataIntoDocuments(
                                                request_SEND_FILE_IMAGE),
                                            "Send File", "image/png",
                                            request_SEND_FILE_IMAGE,
                                            appWindow.useAltImpl)
                        return
        ...
        Page {
            ...
            Button {
                ...
                onClicked: {
                    if (viewSwitch.currentIndex === index_PNG) {
                        shareUtils.viewFile(copyFileFromAppDataIntoDocuments(
                                                request_NO_RESPONSE_IMAGE),
                                            "Send File", "image/png",
                                            request_NO_RESPONSE_IMAGE,
                                            appWindow.useAltImpl)
            ...
            Button {
                ...
                text: Qt.platform.os
                      === "android" ? qsTr("View File with Result\n(recommended)") : qsTr(
                                          "View File with RequestId\n(recommended)")
                onClicked: {
                    if (viewSwitch.currentIndex === index_PNG) {
                        shareUtils.viewFile(copyFileFromAppDataIntoDocuments(
                                                request_VIEW_FILE_IMAGE),
                                            "View File", "image/png",
                                            request_VIEW_FILE_IMAGE,
                                            appWindow.useAltImpl)
                        return
                    ...
                    if (viewSwitch.currentIndex === index_JPEG) {
                        shareUtils.viewFile(copyFileFromAppDataIntoDocuments(
                                                request_VIEW_FILE_JPEG),
                                            "View File", "image/jpeg",
                                            request_VIEW_FILE_JPEG,
                                            appWindow.useAltImpl)
                        return
                    }
            ...
            Button {
                ...
                text: Qt.platform.os
                      === "android" ? qsTr("Check MimeType for VIEW") : qsTr(
                                          "Check MimeType for VIEW\n(not used yet on iOS)")
        ...
        Page {
            ...
            Button {
                ...
                onClicked: {
                    if (editSwitch.currentIndex === index_PNG) {
                        shareUtils.editFile(copyFileFromAppDataIntoDocuments(
                                                request_NO_RESPONSE_IMAGE),
                                            "Edit File", "image/png",
                                            request_NO_RESPONSE_IMAGE,
                                            appWindow.useAltImpl)
            ...
            Button {
                ...
                text: Qt.platform.os
                      === "android" ? qsTr("Edit File with Result\n(recommended)") : qsTr(
                                          "Edit File with RequestId\n(recommeded)")
                onClicked: {
                    if (editSwitch.currentIndex === index_PNG) {
                        shareUtils.editFile(copyFileFromAppDataIntoDocuments(
                                                request_EDIT_FILE_IMAGE),
                                            "Edit File", "image/png",
                                            request_EDIT_FILE_IMAGE,
                                            appWindow.useAltImpl)
                        return
            ...
            Button {
                ...
                text: Qt.platform.os
                      === "android" ? qsTr("Check MimeType for EDIT") : qsTr(
                                          "Check MimeType for EDIT\n(not used yet on iOS)")
                property var theMimeTypes: ["image/png", "image/jpeg", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/pdf"]
    ...
    footer: TabBar {
        ...
        Repeater {
            ...
            model: [qsTr("Home"), qsTr("Text"), qsTr("Send"), qsTr(
                    "View"), qsTr("Edit")]
            TabButton {
                text: modelData
                width: Math.max(90,
                                tabBar.width / tabButtonRepeater.model.length)
            }
        } // tab repeater
    } // footer
    ...
    function onShareEditDone(requestCode) {
        ...
        if (requestCode === request_EDIT_FILE_PDF
                || requestCode === request_EDIT_FILE_IMAGE) {
    ...
    function onShareFinished(requestCode) {
        ...
        if (requestCode === request_VIEW_FILE_PDF
                || requestCode === request_VIEW_FILE_IMAGE
                || requestCode === request_VIEW_FILE_JPEG
                || requestCode === request_VIEW_FILE_DOCX) {
        ...
        if (requestCode === request_EDIT_FILE_PDF
                || requestCode === request_EDIT_FILE_IMAGE
                || requestCode === request_EDIT_FILE_JPEG
                || requestCode === request_EDIT_FILE_DOCX) {
        ...
        if (requestCode === request_SEND_FILE_PDF
                || requestCode === request_SEND_FILE_IMAGE
                || requestCode === request_SEND_FILE_JPEG
                || requestCode === request_SEND_FILE_DOCX) {
    ...
    function onNoDocumentsWorkLocation() {
        popup.labelText = qsTr(
                    "Cannot access external folders and files without checked permissions")
        popup.open()
    }
    ...
    function onFileUrlReceived(url) {
        ...
        var isImage = false
        if (url.endsWith("png") || url.endsWith("jpg") || url.endsWith(
                    "jpeg")) {
            isImage = true
        }
        if (!isImage) {
        ...
        if (Qt.platform.os === "android") {
            if (!myApp.checkPermission()) {
                popup.labelText = qsTr(
                            "Displaying the Image needs permission for external storage\n%1").arg(
                            url)
                popup.open()
                return
            }
